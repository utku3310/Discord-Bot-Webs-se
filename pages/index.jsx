...
export default function Index() {
    ...
    <>
      ...
      <img width="500" src="/img/bck.png" />
        ...
        <p className="animateHeader text-4xl font-extrabold text-center text-white">
          botcommandı davet et!
        </p>
        <p className="animateHeader text-white text-opacity-50 text-center mt-5">
       botcommand çok güzel bir moderasyon botu! 
	  </p>
        <div className="animateHeader mt-10 flex flex-wrap items-center justify-center gap-x-4">
  
            <Link href={"https://discord.com/oauth2/authorize?client_id=1212122878993113098"}>
              <a
                className={
  ...
  <Link href={"https://discord.gg/UBBf624pRg"}>
  <a className={" px-6 justify-center gap-x-2 shadow-lg shadow-amber-600/20 rounded-xl py-4 font-medium bg-gradient-to-bl from-amber-700 to-amber-500 hover:opacity-80 transition duration-200 text-white " }>
botun destek serverine katılın</a>
  </Link>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-y-12 lg:gap-y-0 lg:gap-x-12 py-24">
          <div className="col-span-4">
            ...
            <a href="https://discord.com/oauth2/authorize?client_id=1212122878993113098" className={"mt-10 flex items-center px-4 justify-center gap-x-2 shadow-lg shadow-amber-600/20 cursor-pointer rounded-xl py-4 font-medium bg-gradient-to-r from-amber-700 to-amber-500 hover:opacity-80 transition duration-200 text-white"}>
